    ...
    >
      ...
      <div className="mb-4">
        <div className="flex items-center space-x-2 mb-2">
          <Activity
            className={`w-4 h-4 ${getQualityColor(sensor.lastReading?.quality ?? "good")}`}
          />
      ...
      <div className="flex items-center justify-between">
        ...
        <span
          className={`text-sm font-medium ${getBatteryColor(sensor.batteryLevel ?? 100)}`}
        >
      ...
      {/* Edit/Delete overlay on hover → seulement si props fournies (donc admin) */}
      {(onEdit || onDelete) && (
